...
window.addEventListener("resize", function () {
  ...
  if(window.innerHeight>1650){
    document.getElementById('aboutcontent').style.fontSize = '40px';
  }else{
    document.getElementById('aboutcontent').style.fontSize = '2.3vh';
  }
});
